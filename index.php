...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($layout_type === 'group') {
        ...
        for ($i = 1; isset($_FILES["employee_image_" . $i]); $i++) {
            if ($_FILES["employee_image_" . $i]["error"] == 0) {
                ...
                if (getimagesize($_FILES["employee_image_" . $i]["tmp_name"]) !== false) {
                    if (move_uploaded_file($_FILES["employee_image_" . $i]["tmp_name"], $target_file)) {
                        ...
                        if (isset($_POST["employee_name_" . $i])) {
                            $employee_details[] = [
                ...
                <div class="card slide-up" style="animation-delay: 0.2s">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <label class="cursor-pointer">
                            <input type="radio" name="layout_type" value="0" class="hidden" checked
                                   @change="debug.messages.push('Layout changed to: No Images')">
                            <div class="border-2 border-gray-200 hover:border-indigo-300 rounded-lg p-4 text-center transition-all" :class="{'border-indigo-500 bg-indigo-50': $el.querySelector('input').checked}">
                                <div class="bg-gray-200 h-24 rounded flex items-center justify-center mb-2">
                                    <i class="fas fa-ban text-gray-400 text-xl"></i>
                                </div>
                                <span class="text-sm font-medium">No Images</span>
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="layout_type" value="group" class="hidden"
                                   @change="debug.messages.push('Layout changed to: Group Photo')">
                            <div class="border-2 border-gray-200 hover:border-indigo-300 rounded-lg p-4 text-center transition-all" :class="{'border-indigo-500 bg-indigo-50': $el.querySelector('input').checked}">
                                <div class="bg-gray-200 h-24 rounded flex items-center justify-center mb-2">
                                    <i class="fas fa-users text-gray-400 text-xl"></i>
                                </div>
                                <span class="text-sm font-medium">Group Photo</span>
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="layout_type" value="1" class="hidden"
                                   @change="debug.messages.push('Layout changed to: Single Employee')">
                            <div class="border-2 border-gray-200 hover:border-indigo-300 rounded-lg p-4 text-center transition-all" :class="{'border-indigo-500 bg-indigo-50': $el.querySelector('input').checked}">
                                <div class="bg-gray-200 h-24 rounded flex items-center justify-center mb-2">
                                    <i class="fas fa-user text-gray-400 text-xl"></i>
                                </div>
                                <span class="text-sm font-medium">Single Employee</span>
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="layout_type" value="2" class="hidden"
                                   @change="debug.messages.push('Layout changed to: Two Employees (1x2)')">
                            <div class="border-2 border-gray-200 hover:border-indigo-300 rounded-lg p-4 text-center transition-all" :class="{'border-indigo-500 bg-indigo-50': $el.querySelector('input').checked}">
                                <div class="bg-gray-200 h-24 rounded flex items-center justify-center mb-2 grid grid-cols-2 gap-2 p-2">
                                    <div class="bg-gray-300 rounded-full w-8 h-8 mx-auto"></div>
                                    <div class="bg-gray-300 rounded-full w-8 h-8 mx-auto"></div>
                                </div>
                                <span class="text-sm font-medium">Two Employees (1x2)</span>
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="layout_type" value="3" class="hidden"
                                   @change="debug.messages.push('Layout changed to: Three Employees (1x3)')">
                            <div class="border-2 border-gray-200 hover:border-indigo-300 rounded-lg p-4 text-center transition-all" :class="{'border-indigo-500 bg-indigo-50': $el.querySelector('input').checked}">
                                <div class="bg-gray-200 h-24 rounded flex items-center justify-center mb-2 grid grid-cols-3 gap-2 p-2">
                                    <div class="bg-gray-300 rounded-full w-6 h-6 mx-auto"></div>
                                    <div class="bg-gray-300 rounded-full w-6 h-6 mx-auto"></div>
                                    <div class="bg-gray-300 rounded-full w-6 h-6 mx-auto"></div>
                                </div>
                                <span class="text-sm font-medium">Three Employees (1x3)</span>
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="layout_type" value="2-2" class="hidden"
                                   @change="debug.messages.push('Layout changed to: Four Employees (2x2)')">
                            <div class="border-2 border-gray-200 hover:border-indigo-300 rounded-lg p-4 text-center transition-all" :class="{'border-indigo-500 bg-indigo-50': $el.querySelector('input').checked}">
                                <div class="bg-gray-200 h-24 rounded flex items-center justify-center mb-2 grid grid-cols-2 grid-rows-2 gap-2 p-2">
                                    <div class="bg-gray-300 rounded-full w-6 h-6 mx-auto"></div>
                                    <div class="bg-gray-300 rounded-full w-6 h-6 mx-auto"></div>
                                    <div class="bg-gray-300 rounded-full w-6 h-6 mx-auto"></div>
                                    <div class="bg-gray-300 rounded-full w-6 h-6 mx-auto"></div>
                                </div>
                                <span class="text-sm font-medium">Four Employees (2x2)</span>
                            </div>
                        </label>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <label class="cursor-pointer">
                            <input type="radio" name="layout_type" value="3-2" class="hidden"
                                   @change="debug.messages.push('Layout changed to: Five Employees (3-2)')">
                            <div class="border-2 border-gray-200 hover:border-indigo-300 rounded-lg p-4 text-center transition-all" :class="{'border-indigo-500 bg-indigo-50': $el.querySelector('input').checked}">
                                <div class="bg-gray-200 h-24 rounded flex flex-col items-center justify-center mb-2 p-2">
                                    <div class="grid grid-cols-3 gap-2 mb-2 w-full">
                                        <div class="bg-gray-300 rounded-full w-5 h-5 mx-auto"></div>
                                        <div class="bg-gray-300 rounded-full w-5 h-5 mx-auto"></div>
                                        <div class="bg-gray-300 rounded-full w-5 h-5 mx-auto"></div>
                                    </div>
                                ...
                                <span class="text-sm font-medium">Five Employees (3-2)</span>
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="layout_type" value="3-3" class="hidden"
                                   @change="debug.messages.push('Layout changed to: Nine Employees (3x3)')">
                            <div class="border-2 border-gray-200 hover:border-indigo-300 rounded-lg p-4 text-center transition-all" :class="{'border-indigo-500 bg-indigo-50': $el.querySelector('input').checked}">
                                <div class="bg-gray-200 h-24 rounded flex items-center justify-center mb-2 grid grid-cols-3 grid-rows-3 gap-1 p-2">
                                    <div class="bg-gray-300 rounded-full w-4 h-4 mx-auto"></div>
                                    <div class="bg-gray-300 rounded-full w-4 h-4 mx-auto"></div>
                                    <div class="bg-gray-300 rounded-full w-4 h-4 mx-auto"></div>
                                    <div class="bg-gray-300 rounded-full w-4 h-4 mx-auto"></div>
                                    <div class="bg-gray-300 rounded-full w-4 h-4 mx-auto"></div>
                                ...
                                <span class="text-sm font-medium">Nine Employees (3x3)</span>
                            </div>
                        </label>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="file-upload">
                            <label class="file-upload-label">
                                ...
                                <input type="file" name="group_image" accept="image/*" required
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="file-upload">
                            <label class="file-upload-label">
                                ...
                                <input type="file" name="employee_image_${i}" accept="image/*" required
                                    onchange="updateFileName(this)">
                            </label>
                            <div class="selected-file" style="display: none;"></div>
                        </div>
